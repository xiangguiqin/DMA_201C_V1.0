...
#
# Generated by export_simulation on Wed Sep 11 18:28:50 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ila_64.sh' script.
...
./ila_64.sh -noclean_files

For more information on the script, please type './ila_64.sh -help'.
