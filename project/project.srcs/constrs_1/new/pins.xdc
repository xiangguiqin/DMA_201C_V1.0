...
set_property IOSTANDARD LVCMOS33 [get_ports i_uart_rxd]
set_property IOSTANDARD LVCMOS33 [get_ports o_uart_txd]
...
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[10]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[9]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[8]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[7]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[6]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[5]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[4]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[3]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[2]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[1]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[0]}]
set_property IOSTANDARD DIFF_HSTL_I [get_ports {i_lvds_data_p[11]}]
