...
/** @defgroup USBH_MSC_Enumerations Enumerations
  @{
  */
...
/**@} end of group USBH_MSC_Enumerations */

/** @defgroup USBH_MSC_Type_define Type_define
  @{
  */
...
/**@} end of group USBH_MSC_Type_define */
