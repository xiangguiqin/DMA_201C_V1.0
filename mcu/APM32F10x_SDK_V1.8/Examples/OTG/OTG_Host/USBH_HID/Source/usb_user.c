...
/*!
 * @brief       User Initialization Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User Re-Initialization Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User Reset Device Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User Device Attached Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User Device Detached Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User Device Speed Detected Handler
 *
 * @param       None
 *
 * @retval      None
...
static void USER_DevSpeedDetectedHandler(uint8_t speed)
{
    switch (speed)
    {
        ...
        case USBH_DEVICE_SPEED_LS:
            ...
            #ifdef USB_OTG_HS
            printf(">> High speed host is not supportd for low speed device.\r\n");
            USBH_ConfigHostState(USBH_HOST_SUSPEND);
            #endif
            break;
        default :
...
/*!
 * @brief       User got Device Descriptor Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User got Configuration Descriptor Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User got Manufacturer String Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User got Product String Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User got Serial Number String Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User input Handler, Host will not go to class phase if
 *              the return value is not OK.
 *
 * @param       None
 *
 * @retval      status to show OK or not.
 */
static USER_STATE_T USER_UserInputHandler(void)
{
    return USER_OK;
...
/*!
 * @brief       User Application polling Handler
 *
 * @param       None
 *
 * @retval      status to show OK or not.
...
/*!
 * @brief       User Device is not supported Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User Unrecovered Error Handler
 *
 * @param       None
 *
 * @retval      None
...
/*!
 * @brief       User Delay Functionn
 *
 * @param       cnt : delay counter for us
 *
 * @retval      None
 */
#if (DELAY_SOURCE != USE_DEFAULT)
