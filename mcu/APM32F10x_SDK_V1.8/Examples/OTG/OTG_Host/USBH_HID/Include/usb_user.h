...
/** @defgroup USBH_HID_Enumerations Enumerations
  @{
  */
...
/**@} end of group USBH_HID_Enumerations */

/** @defgroup USBH_HID_Type_define Type_define
  @{
  */
...
/**@} end of group USBH_HID_Type_define */
