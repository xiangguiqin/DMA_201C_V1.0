...
#ifdef APM32F40X
#define UID_ADDRESS1                        (0x1FFF7A10 + 0)
#define UID_ADDRESS2                        (0x1FFF7A10 + 4)
#define UID_ADDRESS3                        (0x1FFF7A10 + 8)
#else
#define UID_ADDRESS1                        (0x1FFFF7E8 + 0)
#define UID_ADDRESS2                        (0x1FFFF7E8 + 4)
#define UID_ADDRESS3                        (0x1FFFF7E8 + 8)
#endif

#define USB_DEVICE_DESCRIPTOR_SIZE          (18)
#define USB_CONFIG_DESCRIPTOR_SIZE          (3*9 +7)
...
extern uint8_t g_hidMouseReportDescriptor[74];
