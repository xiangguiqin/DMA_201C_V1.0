...
/*!
 * @brief     Control the height of GPIO_Pin of SMBusAlert
 *
 * @param     i2c: I2C selet 1 or 2
 *
 * @param     SMBusState: SMBAlert GPIO_Pin level.
 *              The parameter can be one of following values:
 *              @arg I2C_SMBUSALER_LOW: SMBus Alert GPIO_Pin low
 *              @arg I2C_SMBUSALER_HIGH: SMBus Alert GPIO_Pin high
 * @retval    None
 */
