 ...
 *                    @arg BAKPR_TAMPER_PIN_LEVEL_HIGH: Tamper GPIO_Pin active on high level
 *                    @arg BAKPR_TAMPER_PIN_LEVEL_LOW: Tamper GPIO_Pin active on low level
 *
 * @retval     None
 */
...
/*!
 * @brief   Select the RTC output source to output on the Tamper GPIO_Pin.
 *
 * @param   soure: specifies the RTC output source.
 *            This parameter can be one of the following values:
 *            @arg BAKPR_RTC_OUTPUT_SOURCE_NONE             : no RTC output on the Tamper GPIO_Pin.
 *            @arg BAKPR_RTC_OUTPUT_SOURCE_CALIBRATION_CLOCK: output the RTC clock with frequency divided by 64 on the Tamper GPIO_Pin.
 *            @arg BAKPR_RTC_OUTPUT_SOURCE_ALARM            : output the RTC Alarm pulse signal on the Tamper GPIO_Pin.
 *            @arg BAKPR_RTC_OUTPUT_SOURCE_SECOND           : output the RTC Second pulse signal on the Tamper GPIO_Pin.
 *
 * @retval  None
 */
