...
extern struct rt_timer rt_timer_periodic_read;

const uint8 *get_tx_edid(void)
{
	return InEdid;
}
/**
...
//			rt_timer_stop(&rt_timer_periodic_read);
            if(port->content.rx->EdidStatus != AV_EDID_UPDATED)
            {
                AvEdidPortManage(port);
                port->content.rx->EdidStatus = AV_EDID_UPDATED;
            }
//			rt_timer_start(&rt_timer_periodic_read);
            break;

        case AvEventPortEdidReady:
            AvEdidPortAnalysis(port);
			//extern void post_update_tx_edid_event(void);
			//extern void set_rx_syn(void);
			//set_rx_syn();
			//post_update_tx_edid_event();
			//post update tx edid event
            /* Resend Edid */
            if(KfunFindVideoRxFront(port, &TempPort) == AvOk)
            {
                if(TempPort->type == HdmiRx)
...
#endif /* CEC Related */
//static const uint8 Dflt_KONKA[] =
//{
//0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x2d, 0xe1, 0x30, 0x00, 0x01, 0x01, 0x01, 0x01, 
...
//0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x08, 0xe8, 0x20, 0x30, 0xf2, 0x70, 0x5a, 0x80, 0xb0, 0x58, 
...
//0x4f, 0x4e, 0x4b, 0x41, 0x20, 0x54, 0x56, 0x0a, 0x20, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0xfd, 
//0x00, 0x30, 0x4c, 0x0f, 0x55, 0x3c, 0x00, 0x0a, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x01, 0xfc, 
//0x02, 0x03, 0x67, 0x74, 0x54, 0x61, 0x60, 0x66, 0x65, 0x02, 0x04, 0x11, 0x13, 0x20, 0x22, 0x90, 
//0x21, 0x1f, 0x06, 0x15, 0x03, 0x12, 0x16, 0x05, 0x14, 0x32, 0x09, 0x7f, 0x01, 0x15, 0x07, 0x50, 
//0x57, 0x07, 0x01, 0x3d, 0x07, 0x50, 0x5f, 0x7e, 0x01, 0x67, 0x04, 0x03, 0x83, 0x01, 0x00, 0x00, 
//0x6d, 0x03, 0x0c, 0x00, 0x10, 0x00, 0xb8, 0x3c, 0x20, 0x00, 0x60, 0x01, 0x02, 0x03, 0x67, 0xd8, 
//0x5d, 0xc4, 0x01, 0x78, 0xc0, 0x03, 0xe2, 0x00, 0xcf, 0xe3, 0x05, 0xc0, 0x00, 0xe2, 0x0f, 0x0f, 
//0xe3, 0x06, 0x0d, 0x01, 0xe6, 0x11, 0x46, 0xd0, 0x00, 0x70, 0x80, 0xeb, 0x01, 0x46, 0xd0, 0x00, 
//0x43, 0x0c, 0x43, 0x98, 0x99, 0xee, 0xd3, 0x01, 0x1d, 0x00, 0xbc, 0x52, 0xd0, 0x1e, 0x20, 0xb8, 
//0x28, 0x55, 0x40, 0xc4, 0x8e, 0x21, 0x00, 0x00, 0x1e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06
//};
uint8 hx_EDID[] =
{
0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x2E, 0xCD, 0x30, 0x00, 0x01, 0x00, 0x00, 0x00,
0x10, 0x1C, 0x01, 0x03, 0x80, 0x73, 0x41, 0x78, 0x0A, 0xCF, 0x74, 0xA3, 0x57, 0x4C, 0xB0, 0x23,	
...
,	
...
AvRet AvEdidPortManage(AvPort *RxPort)
{
    ...
    AvMemcpy(OutEdid+0,(void*)(&hx_EDID[0]),256);
